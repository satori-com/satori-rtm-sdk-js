...
| [opts.protocol] | <code>&#x27;json&#x27;</code> &#124; <code>&#x27;cbor&#x27;</code> | <code>&#x27;json&#x27;</code> | WebSocket protocol to use <br> The SDK automatically converts messages to the protocol you choose. For example, if you specify <code>opts.protocol = 'cbor'</code> and then publish a JSON object, the SDK converts it to CBOR. <br> If you don't specify a protocol, RTM defaults to JSON protocol. |
